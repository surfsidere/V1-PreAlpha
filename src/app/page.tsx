...
// Import ShieldCheck and Building2, keep SwatchBook
import { ArrowRight, BarChart3, Megaphone, Cpu, SwatchBook, ShieldCheck, Building2 } from 'lucide-react';
      ...
      <section id="audience-portals" className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="group flex flex-col items-center text-center p-8 md:p-12 rounded-lg border border-border hover:shadow-xl transition-all duration-300 ease-in-out transform hover:-translate-y-1">
              {/* Use Building2 icon */}
             <Building2 className="mb-5 text-primary transition-transform duration-300 group-hover:scale-110 w-12 h-12"/>
