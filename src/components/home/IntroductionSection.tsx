...
const IntroductionSection: React.FC<IntroductionSectionProps> = ({}) => {
  ...
  return (
    ...
    >
      ...
      {/* Gradient Overlay - Changed to fade from the right */}
      ...
      {/* Text Content Container */}
       ...
       <div className="relative z-20 container mx-auto px-4 py-16 md:py-24 lg:py-32 w-full max-w-screen-lg">
         {/* Inner div limits content width to ~70% and ensures RIGHT alignment */}
         {/* Changed md:w-[70%] to md:w-[65%], added ml-auto for right alignment, changed text-left to text-right */}
