...
import { Twitter, Linkedin, Instagram } from 'lucide-react'; // Assuming usage of Lucide icons
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <address className="not-italic space-y-2 text-sm mb-4">
              <p>123 Luxury Ave,<br />Cabo San Lucas, BCS, Mexico</p>
              <p><a href="mailto:info@surfside.re" className="hover:text-primary transition-colors">info@surfside.re</a></p>
              <p><a href="tel:+521234567890" className="hover:text-primary transition-colors">+52 (123) 456-7890</a></p>
            </address>
